...
class Lexer:
    ...
    def getToken(self):
        ...
        if self.curChar == '+':
            ...
            if isFixnum:
                token = Token(tokText, TokenType.FIXNUM)
            else:
            ...
            if keyword == None: # Identifier
                ...
                if tokText in ['GCD', 'DUP', 'SWAP', 'OVER', 'DROP', 'INPUT', 'RAWIN', 'DEPTH', 'ADD', 'SUB', 'MUL', 'DIV', 'FLOOR', 'CEIL', 'ROUND', 'INT', 'FPN', 'ISQRT', 'RND', 'SQRT']:
